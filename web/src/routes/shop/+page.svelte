<script lang="ts">
  ...
  async function loadProducts() {
    ...
    let queryRef = query(discountsRef, ...filters, orderBy(sortKey, sortDirection));
...
<div class="w-full">
  ...
  <div class="flex">
    <div class="w-[400px] bg-gray-200 p-4 h-[400px]">
          ...
          {#each tags as tag (tag.id)}
            <button
              ...
              class="{tag.active
                ...
                : 'bg-gray-300 text-gray-700'} mr-2 mb-2 px-4 py-2 rounded-md focus:outline-none focus:ring focus:border-blue-300"
      ...
      <select
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        bind:value={currentFilters.sortOption}
      >
