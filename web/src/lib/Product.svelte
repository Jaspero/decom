    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center justify-start flex-wrap">
            ...
            <div class="w-full flex justify-between items-center text-gray-900 dark:text-white">
                ...
                {:else}
                    <button on:click={() => {removeItem = true}} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Remove
                    </button>
                {/if}
...
<Dialog bind:showing={removeItem}>
    ...
    <div class="flex w-full justify-center">
        <button class="bg-red-700 p-4 text-white rounded-lg mr-[10px]" on:click={removeFromCart}>Yes</button>
        <button class="bg-black text-white rounded-lg p-4" on:click={() => {removeItem = false}}>Cancel</button>
    </div>
</Dialog>
