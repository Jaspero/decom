            ...
            {#if showCodeInput}
                <GridCol span="12" spanxl="6">
                    <form on:submit={confirm}>
                        <Button variant="outlined" color="warning" href="/login" on:click={back}>Back to login</Button>
                        <div class="mt-12 mb-24 w-full">We have sent you a 6-digit verification code to:
                            <b>{resolver.hints[0].phoneNumber}</b></div>
            ...
            {:else}
                <GridCol span="12" spanxl={showCodeInput ? '3' : '8'}>
                    ...
                    <div class="mt-4">
                        ...
                        <Button color="secondary" on:click={() => (resetPasswordDialog = open)}
                        >Reset password
                        </Button>
                    </div>
